...
class MongoBinaryDownload {
  constructor({
    ...
    _defineProperty(this, "skipMD5", void 0);
    ...
    if (skipMD5 === undefined) {
      this.skipMD5 = typeof process.env.MONGOMS_SKIP_MD5_CHECK === 'string' && ['1', 'on', 'yes', 'true'].indexOf(process.env.MONGOMS_SKIP_MD5_CHECK.toLowerCase()) !== -1;
    } else {
  ...
  startDownload() {
    ...
    return _asyncToGenerator(function* () {
      ...
      yield _this2.checkMD5(`${downloadUrl}.md5`, mongoDBArchive);
      return mongoDBArchive;
    })();
  }

  checkMD5(urlForReferenceMD5, mongoDBArchive) {
    var _this3 = this;
